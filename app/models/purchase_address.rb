class PurchaseAddress
  ...
  attr_accessor :user_id, :item_id, :zip, :shipping_from_id, :address_line1, :address_line2, :telephone, :building, :token
  ...
  def save
    ...
    Address.create(zip: zip, shipping_from_id: shipping_from_id, address_line1: address_line1, address_line2: address_line2,
